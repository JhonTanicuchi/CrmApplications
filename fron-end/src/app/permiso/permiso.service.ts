...
export class PermisoService {
  ...
  public save(permiso: Permiso): Observable<Permiso>
  {
    ...
    (this.url+"/save",permiso,this.httpOptions);
  }
  ...
  {
    return this.http.put<Permiso>(this.url+"/update", permiso, this.httpOptions);
  }
  ...
  public findAllByName(termino: string): Observable<Permiso[]>
  {
    return this.http.get<Permiso[]>(this.url+"/findByName/"+termino, this.httpOptions);
  }
}
